...
from langchain_google_genai import ChatGoogleGenerativeAI   ## for chatting capabilities using Google GEN AI
...
genai.configure(api_key="AIzaSyAD0uySskGppmyCXQxf3Bfe4gN8dE-unQ8")
...
st.set_page_config(page_title="SON's Chat with PDF", page_icon="📜")
st.header("Chat With PDF Web Application of SON")

# 파일 업로드 창과 버튼을 기본 화면으로 이동
